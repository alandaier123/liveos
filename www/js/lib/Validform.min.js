...
(function($, win, undef) {
    ...
    var Validform = function(forms, settings, inited) {
        ...
        forms.each(function() {
            ...
            var curform = this;
            curform.settings = $.extend({},
            settings);
            var $this = $(curform);
            curform.validform_status = "normal";
            $this.data("tipmsg", brothers.tipmsg);
            $this.delegate("[datatype]", "blur",
            function() {
                var subpost = arguments[1];
                Validform.util.check.call(this, $this, subpost)
            });
            $this.delegate(":text", "keypress",
            function(event) {
            ...
            curform.settings.btnSubmit && $this.find(curform.settings.btnSubmit).bind("click",
            function() {
                $this.trigger("submit");
                return false
            });
            ...
            $this.find("[type='reset']").add($this.find(curform.settings.btnReset)).bind("click",
            function() {
    ...
    Validform.util = {
        ...
        getErrormsg: function(curform, datatype, recheck) {
            ...
            var tipmsg_w_ex = $.extend({},
            tipmsg.w, curform.data("tipmsg").w);
